...
export const ThemeLogo: React.FC<ThemeLogoProps> = ({ 
  ...
  // Color scheme: Dark mode uses white, Light mode uses NFTOPIA blue
  const logoColor = isDark ? '#FFFFFF' : '#3A7BFA';
